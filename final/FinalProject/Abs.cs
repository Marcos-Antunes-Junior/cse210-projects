...
public class Abs : Exercises
{
    private string _name;
    private string _description;
    private List<string> _abs = new List<string>();

    public Abs(string name, string description) : base(name, description)
    {
        _name = name;
    ...
    public override void StartExercise(int reps, int sets, int restTime)
    {
        ...
        {
            Console.Clear();
            Console.WriteLine($"Number of exercises: {_abs.Count}/{i + 1}");
            Console.WriteLine(_abs[i]);
            string userInput;
            Console.WriteLine("");
